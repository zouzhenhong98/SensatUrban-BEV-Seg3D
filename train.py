...
class Trainer(object):
    def __init__(self, args):
        ...
        # Define network
        model = Unet(n_channels=4, n_classes=14)
        train_params = [{'params': model.parameters(), 'lr': args.lr}]

        # print('num of params {:3.3f} M'.format(sum(p.numel() for p in model.parameters())/1e6))
        # assert False
        ...
        if args.resume is not None:
            ...
            if args.cuda:
                ...
                weight_dict = {k: v for k, v in model_dict.items() if k in checkpoint}
    ...
    def validation(self, epoch):
        ...
        mIoU, IoU = self.evaluator.Mean_Intersection_over_Union_more()
